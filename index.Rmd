...
```{r actual_run, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
...
shapeobj1<-  st_read("data/Erie_2018_Tax_Parcel_Centroid_Points_SHP.shp")
# unlink(temp)
...
```
![screen of result](/data/Screenshot at 2019-12-05 14-18-39.png)
